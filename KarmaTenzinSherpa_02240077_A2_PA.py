#MY_Game:)
import random
from KarmaTenzinSherpa_02240077_A2_PB import run_game
...
def main_menu():
    while True:
        ...
        choice = input("Select a mode (1-5): ").strip()
        ...
        if choice == '1':
            ...
            game3 = TriviaGame()
            game3.add_question(q1)
            game3.add_question(q2)
            game3.add_question(q3)
            game3.add_question(q4)
            game3.add_question(q5)
            game3.add_question(q6)
            game3.add_question(q7)
            game3.add_question(q8)
            game3.add_question(q9)
            game3.add_question(q10)
            game3.play()
